  ...
  return (
    <div className="border-b sticky top-0 z-50 bg-white/[95%]">
      <div className="flex justify-between items-center sm:mx-6 md:mx-10 lg:mx-12">
        {/* Left */}
        <div className="h-20 flex" onClick={goToHomePage} style={{ cursor: 'pointer' }}>
        ...
        {/* Right */}
        <div onClick={onFavoritesClick} className="mx-3 text-gray-600 hover:text-black cursor-pointer">
            Favorites
          </div>
        <div className="flex items-center pr-3 font-semibold text-gray-600">
          ...
          <p className="text-[17px] mx-4">Rent House</p>
          <div
